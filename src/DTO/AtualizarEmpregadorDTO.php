...
class AtualizarEmpregadorDTO
{
    ...
    public function validate()
    {
        ...
        //     'tpInsc' => $this->tpInsc,
        //     'nrInsc' => $this->nrInsc,
        //     'nmRazao' => $this->nmRazao,
        //     'iniValid' => $this->iniValid,
        //     'fimValid' => $this->fimValid,
        //     'classTrib' => $this->classTrib,
        //     'indCoop' => $this->indCoop,
        //     'indConstr' => $this->indConstr,
        //     'indDesFolha' => $this->indDesFolha,
        //     'indopccp' => $this->indopccp,
        //     'indporte' => $this->indporte,
        //     'indOptRegEletron' => $this->indOptRegEletron,
        //     'cnpjEFR' => $this->cnpjEFR,
        //     'dttrans11096' => $this->dttrans11096,
        //     'indtribfolhapiscofins' => $this->indtribfolhapiscofins,
        //     'natJurid' => $this->natJurid,
        //     'multTabRubricas' => $this->multTabRubricas,
        //     'indEntEd' => $this->indEntEd,
        //     'indEtt' => $this->indEtt,
        //     'nrRegEtt' => $this->nrRegEtt,
        //     'ideMinLei' => $this->ideMinLei,
        //     'nrCertif' => $this->nrCertif,
        //     'dtEmisCertif' => $this->dtEmisCertif,
        //     'dtVencCertif' => $this->dtVencCertif,
        //     'nrProtRenov' => $this->nrProtRenov,
        //     'dtProtRenov' => $this->dtProtRenov,
        //     'dtDou' => $this->dtDou,
        //     'pagDou' => $this->pagDou,
        //     'nmCtt' => $this->nmCtt,
        //     'cpfCtt' => $this->cpfCtt,
        ...
        //     'indRPPS' => $this->indRPPS,
        //     'subteto' => $this->subteto,
        //     'vrSubteto' => $this->vrSubteto,
        //     'indAcordoIsenMulta' => $this->indAcordoIsenMulta,
        //     'indSitPJ' => $this->indSitPJ,
        //     'obs' => $this->obs,
        //     'obsPPP' => $this->obsPPP,
        //     'obsASO' => $this->obsASO,
        // ], [
        //     'tpInsc' => ['nullable', 'integer', 'in:0,1'],
        //     'nrInsc' => ['nullable', 'integer', 'unique:empregadores,nrInsc'],
        //     'nmRazao' => ['nullable', 'string', 'max:115'],
        //     'iniValid' => ['nullable', 'date_format:Y-m'],
        //     'fimValid' => ['nullable', 'date_format:Y-m'],
        //     'classTrib' => ['nullable', 'string', 'size:2'],
        //     'indCoop' => ['nullable', 'string', 'size:1'],
        //     'indConstr' => ['nullable', 'string', 'size:1'],
        //     'indDesFolha' => ['nullable', 'string', 'size:1'],
        //     'indopccp' => ['nullable', 'string', 'size:1'],
        //     'indporte' => ['nullable', 'string', 'size:1'],
        //     'indOptRegEletron' => ['nullable', 'string', 'size:1'],
        //     'cnpjEFR' => ['nullable', 'string', 'size:14'],
        //     'dttrans11096' => ['nullable', 'date_format:Y-m-d'],
        //     'indtribfolhapiscofins' => ['nullable', 'string', 'size:7'],
        //     'natJurid' => ['nullable', 'string', 'size:4'],
        //     'multTabRubricas' => ['nullable', 'string', 'size:1'],
        //     'indEntEd' => ['nullable', 'string', 'size:1'],
        //     'indEtt' => ['nullable', 'string', 'size:1'],
        //     'nrRegEtt' => ['nullable', 'string', 'max:30'],
        //     'ideMinLei' => ['nullable', 'string', 'max:70'],
        //     'nrCertif' => ['nullable', 'string', 'max:40'],
        //     'dtEmisCertif' => ['nullable', 'date_format:Y-m-d'],
        //     'dtVencCertif' => ['nullable', 'date_format:Y-m-d'],
        //     'nrProtRenov' => ['nullable', 'string', 'max:40'],
        //     'dtProtRenov' => ['nullable', 'date_format:Y-m-d'],
        //     'dtDou' => ['nullable', 'date_format:Y-m-d'],
        //     'pagDou' => ['nullable', 'integer'],
        //     'nmCtt' => ['nullable', 'string', 'max:70'],
        //     'cpfCtt' => ['nullable', 'string', 'size:11'],
        //     'foneFixo' => ['nullable', 'string', 'size:13'],
        //     'foneCel' => ['nullable', 'string', 'size:13'],
        //     'email' => ['nullable', 'email', 'max:60'],
        //     'nrSiafi' => ['nullable', 'string', 'size:6'],
        //     'ideEFR' => ['nullable', 'string', 'size:1'],
        //     'website' => ['nullable', 'url', 'max:255'],
        //     'logo' => ['nullable', 'string'],
        //     'nmEnte' => ['nullable', 'string', 'max:115'],
        //     'uf' => ['nullable', 'string', 'size:2'],
        //     'codMunic' => ['nullable', 'string', 'size:7'],
        //     'indRPPS' => ['nullable', 'string', 'size:1'],
        //     'subteto' => ['nullable', 'string', 'size:1'],
        //     'vrSubteto' => ['nullable', 'numeric', 'max:99999999999999.99'],
        //     'indAcordoIsenMulta' => ['nullable', 'string', 'size:1'],
        //     'indSitPJ' => ['nullable', 'string', 'size:1'],
        //     'obs' => ['nullable', 'string'],
        //     'obsPPP' => ['nullable', 'string'],
        //     'obsASO' => ['nullable', 'string'],
        // ]);
